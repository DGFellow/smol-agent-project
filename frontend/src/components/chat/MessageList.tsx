// src/components/chat/MessageList.tsx - UNIFIED BUBBLE
...
export function MessageList({ 
  ...
  // ✅ Show answering bubble if thinking OR streaming
  ...
  return (
    ...
    >
      <AnimatePresence mode="popLayout">
        ...
        {/* ✅ UNIFIED: Single bubble for thinking + streaming response */}
        {isAnswering && (
          <MessageBubble
            key="answering-message"
            message={{
              id: -1,
              role: 'assistant',
              ...
              reaction: null,
              // ✅ Include thinking data in the message
